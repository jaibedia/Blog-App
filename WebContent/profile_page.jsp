			...
			<div class="row mt-4">
				...
				<div class="col-md-4">
					...
					<div class="list-group">
						<a href="#" onclick="getPost(0)" class="list-group-item list-group-item-action active">All
							Posts</a>

						<!-- get categories -->
						<%
							PostDao dao = new PostDao();
								ArrayList<Category> list2 = dao.getAllCategories();
				...
				<div class="col-md-8">
					...
					<div class="container text-center" id="loader">
						<i class="fa fa-loader fa-refresh fa-4x fa-spin"></i>
						<h3 class="mt-3">Lodding..</h3>
					</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form action="AddPostServlet" id="add-post-form" method="post">
						...
						<div class=form-group>
							<textarea name="pContent" rows="4" cols="20" class="form-control"
